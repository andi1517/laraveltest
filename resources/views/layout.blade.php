...
<body>
    ...
    <div id="header-wrapper">
        <div id="header" class="container">
            ...
            <div id="menu">
                <ul>
                    <li class="{{ (Request::path() === '/') || (Request::path() === 'welcome') ? 'current_page_item' : ''}}"><a href="/welcome" accesskey="1" title="">Welcome</a></li>
                    ...
                    <li class="{{ Request::is('[a-z]*[0-9]*regtest') ? 'current_page_item' : ''}}"><a href="regtest" accesskey="9" title="">RegTest</a></li>
                </ul>
            </div>
        </div>
        @yield('header')
